...
void main() {
  group('TerminalSize', () {
    ...
    test('hashCode differs when a dimension differs', () {
      ...
      // constant (which would silently break hash-based collections). Note:
      // hashCode is width ^ height, so swapped dimensions (24, 80) vs (80, 24)
      // intentionally collide — allowed by the equality contract.
      final hashes = {
        const TerminalSize(80, 24).hashCode,
